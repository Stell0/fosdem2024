...
question = "I want to submit a talk about cobol, what is the right place to do it?"

docs = db.similarity_search(question)
unique_docs = []
[unique_docs.append(element) for element in docs if element not in unique_docs]
